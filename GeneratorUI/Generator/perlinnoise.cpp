...
double PerlinNoise::smoothNoise(double x, double y) {
    ...
    double x1 = cosine_interpolate(gradient(aa, x_fractional_part, y_fractional_part), gradient(ba, x_fractional_part - 1, y_fractional_part), u);
    double y1 = cosine_interpolate(gradient(ab, x_fractional_part, y_fractional_part - 1), gradient(bb, x_fractional_part - 1, y_fractional_part - 1), u);

...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        generatePB->setGeometry(QRect(20, 550, 111, 41));
        ...
        octavesL->setGeometry(QRect(20, 460, 101, 31));
        amplitudeL = new QLabel(centralwidget);
        amplitudeL->setObjectName("amplitudeL");
        amplitudeL->setGeometry(QRect(20, 500, 81, 20));
        ...
        octavesSB->setGeometry(QRect(100, 460, 141, 26));
        ...
        editOtavesPB->setGeometry(QRect(260, 460, 93, 29));
        ...
        amplitudeSB = new QSpinBox(centralwidget);
        amplitudeSB->setObjectName("amplitudeSB");
        amplitudeSB->setGeometry(QRect(100, 500, 141, 26));
        amplitudeSB->setMinimum(1);
        amplitudeSB->setMaximum(10);
        ...
        imagePB->setGeometry(QRect(160, 550, 111, 41));
